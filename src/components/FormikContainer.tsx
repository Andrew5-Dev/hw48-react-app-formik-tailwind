...
const validationSchema = Yup.object({
    ...
    selectOption: Yup.string().required('Обов’язковий Вибір'),
    radioOption: Yup.string().required('Обов’язковий Вибір'),
    checkboxOption: Yup.array().min(1, 'Обов’язковий Вибір'),
    date: Yup.mixed().required('Дата є обов’язковим полем')
})
